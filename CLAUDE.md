...
| Layer | What | Where |
|---|---|---|
| Engine A | Deterministic calendar conversion (Python: pyluach, hijri-converter, convertdate). No LLM, no hallucination risk. | `~/Projects/Anno/` + `/home/ichabod/01_Infrastructure/Anno/` |
...
- Shared Primitives: Consumes deterministic calendar conversions from Engine A (`calendar_engine.py`). Mirror copy maintained at `/home/ichabod/01_Infrastructure/Anno/`.

## Constraints

- Xcode/macOS required for native build. No ichabod-side build step.
- Infrastructure Engine A copy lives at `/home/ichabod/01_Infrastructure/Anno/` — reconciled as of 2026-07-04. Keep in sync.
