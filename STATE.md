...
- Native iOS build can be delegated from `docs/NATIVE_IOS_BUILD_TASKS.md`.
- Artwork rights work can start from `data/assets/artwork_clearance_queue_2026-07-03_2026-07-16.json` and `docs/ARTWORK_CLEARANCE_PLAYBOOK.md`.
